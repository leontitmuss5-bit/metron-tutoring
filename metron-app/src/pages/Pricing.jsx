        ...
        <>
            <header className="relative pt-16 pb-10 md:pt-24 md:pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-6 lg:px-8 text-center">
                    <span className="inline-block py-1 px-3 rounded-full bg-primary/5 text-primary-accent text-[10px] md:text-xs font-semibold tracking-widest uppercase mb-3 md:mb-4 dark:bg-white/5">Elite Academic Investment</span>
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-10 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 lg:gap-12 max-w-5xl mx-auto">
                    ...
                    <div className="pricing-card flex flex-col">
                        <div className="p-5 md:p-8 pb-3 md:pb-4">
                            <span className="text-[10px] md:text-xs font-bold text-primary-accent uppercase tracking-widest mb-2 block">Flexible Learning</span>
                            <h3 className="text-2xl md:text-3xl font-serif font-medium text-primary dark:text-white mb-3 md:mb-4">Single Session</h3>
                            <div className="flex items-baseline gap-1 mb-4 md:mb-6">
                                <span className="text-3xl md:text-4xl font-serif font-medium text-primary dark:text-white">$85</span>
                                <span className="text-text-muted-light dark:text-text-muted-dark font-light text-sm">/ hour</span>
                            </div>
                            ...
                            <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    ...
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">One-on-one personalized mentoring</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">Targeted curriculum support (HSC/IB)</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">Comprehensive study materials</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">No long-term commitment</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="pricing-card flex flex-col relative">
                        <div className="absolute top-3 right-3 md:top-4 md:right-4">
                            <span className="bg-primary-accent text-primary text-[9px] md:text-[10px] font-bold px-2.5 md:px-3 py-1 rounded uppercase tracking-wider shadow-sm">Recommended</span>
                        </div>
                        <div className="p-5 md:p-8 pb-3 md:pb-4">
                            ...
                            <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                                ...
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">Priority scheduling with Senior Tutors</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">24/7 Q&amp;A support via Slack</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">Fortnightly progress reports</span>
                                </li>
                                <li className="flex items-start gap-2.5 md:gap-3">
                                    <span className="material-symbols-outlined text-primary-accent text-sm mt-0.5">check_circle</span>
                                    <span className="text-xs md:text-sm text-text-muted-light dark:text-text-muted-dark">Exam strategy masterclasses</span>
                                </li>
                            </ul>
                        </div>
                        <div className="mt-auto p-5 md:p-8 pt-0">
                ...
                <section className="mt-16 md:mt-32 max-w-3xl mx-auto">
                    <div className="text-center mb-10 md:mb-16">
                        <h2 className="text-2xl md:text-3xl font-serif font-medium text-primary dark:text-white mb-3 md:mb-4">Frequently Asked Questions</h2>
                        <p className="text-sm md:text-base text-text-muted-light dark:text-text-muted-dark">Find answers to common questions about our premium services.</p>
                    </div>
                    <div className="space-y-3 md:space-y-4">
                        {faqs.map((faq, index) => (
                            <div key={index} className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-xl p-4 md:p-6">
                                <button
                                    onClick={() => toggleFaq(index)}
                                    className="flex justify-between items-center w-full text-left gap-3"
                                >
                                    <span className="text-sm md:text-lg font-medium text-primary dark:text-white">{faq.question}</span>
            ...
            <section className="bg-surface-light dark:bg-surface-dark border-y border-border-light dark:border-border-dark py-14 md:py-20">
                <div className="max-w-4xl mx-auto px-5 md:px-6 text-center">
                    <h2 className="text-2xl md:text-4xl font-serif text-primary dark:text-white mb-4 md:mb-6">Invest in Excellence Today</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                        <Link to="#" className="bg-primary text-white hover:bg-black/90 px-6 md:px-8 py-3 rounded-md font-medium shadow-lg transition-all text-sm md:text-base">Book Consultation</Link>
                        <Link to="#" className="border border-primary text-primary hover:bg-primary hover:text-white px-6 md:px-8 py-3 rounded-md font-medium transition-all dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-primary text-sm md:text-base">Contact Us</Link>
                    </div>
                </div>
            </section>
        </>
