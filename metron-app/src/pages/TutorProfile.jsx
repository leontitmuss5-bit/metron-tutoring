                    ...
                    <div className="lg:col-span-7 space-y-12">
                        ...
                        <section className="space-y-6">
                            ...
                            <ul className="space-y-4">
                                ...
                                <li className="flex items-center gap-3 text-sm">
                                    <span className="material-symbols-outlined text-primary-accent text-lg">verified</span>
                                    <span>Lead author of the Real Balance "Ext 2 Strategy" Workbook</span>
                                </li>
                            </ul>
                        </section>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg text-text-muted-light dark:text-text-muted-dark">
                                Experience the Real Balance difference. Our consultations are designed to map out a clear path to your academic goals.
                            </p>
                        </div>
